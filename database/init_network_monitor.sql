...
CREATE TABLE `sys_traffic_monitor` (
  ...
  `request_body` LONGTEXT DEFAULT NULL COMMENT '请求体(仅异常流量保存,state_value!=0或state_tag!=NORMAL)',
  `response_status` INT DEFAULT NULL COMMENT '响应状态码',
  `response_body` LONGTEXT DEFAULT NULL COMMENT '响应体(仅异常流量保存,state_value!=0或state_tag!=NORMAL)',
  `has_body` TINYINT DEFAULT 0 COMMENT '是否保存请求/响应体(0-否,1-是)',
